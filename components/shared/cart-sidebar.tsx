...
export default function CartSidebar() {
  ...
  <div className='fixed h-full border-l bg-white dark:bg-black text-black dark:text-white z-50'>
    <div className='h-full flex flex-col items-center justify-start gap-2 p-2'>
      ...
      <div className='text-center space-y-2 w-full'>
        ...
        {itemsPrice > FREE_SHIPPING_MIN_PRICE && (
          <div className='text-xs text-center text-green-500 dark:text-green-400'>
          ...
          <div key={item.clientId}>
            <div className='my-3 px-2'>
              ...
              <div className='mt-2 flex gap-2 items-center justify-center'>
                ...
                >
                  <SelectTrigger className='ml-1 h-auto w-14 py-1 text-xs border dark:text-white dark:border-gray-600'>
